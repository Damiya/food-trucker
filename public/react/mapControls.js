            ...
            return (
                React.DOM.div({id: "map-controls"}, 
                    React.DOM.div({className: "input-group"}, 
                        OverlayTrigger({placement: "right", overlay: Tooltip(null, homeTooltip)}, 
                            React.DOM.span({className: "input-group-addon", onClick: self.onHomeClick, disabled: !this.props.geolocationAvailable}, 
